...
export const projects: Project[] = [
  ...
  },
  {
    ...
    lead: "Pet adoption website case study coming soon.",
    tags: ["Design"],
    role: "Designer",
    timeline: "2025",
    tools: "Figma",
    type: "Brand",
    overview: ["Pet adoption website overview goes here."],
    challenge: ["Pet adoption website challenge goes here."],
    process: ["Pet adoption website process goes here."],
    outcome: ["Pet adoption website outcome goes here."],
